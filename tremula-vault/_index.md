...
- [[architecture/architecture-memory-is-project-scoped-not-branch-aware-single-trunk-assumption]] — Architecture: Memory is project-scoped, not branch-aware (single-trunk assumption) [architecture, distilled]
- [[architecture/architecture-root-vaults-are-born-empty-enriched-by-member-distillers]] — Architecture: Root vaults are born empty, enriched by member distillers [architecture, distilled]
...
- [[conventions/convention-commit-messages-and-pr-descriptions-are-public-artifacts-no-internal-process-vocabulary]] — Convention: commit messages and PR descriptions are public artifacts — no internal process vocabulary [convention, distilled]
- [[conventions/convention-committed-artifacts-vs-local-working-state-in-gitignore]] — Convention: committed artifacts vs. local working state in .gitignore [convention, distilled]
...
- [[conventions/convention-index-migrated-columns-in-migrate-not-the-static-schema]] — Convention: index migrated columns in _migrate(), not the static schema [convention, distilled]
- [[conventions/convention-pypi-token-storage-and-security]] — Convention: PyPI publishing — twine + ~/.pypirc [convention]
- [[conventions/convention-tremulaignore-skip-pattern-format]] — Convention: .tremulaignore skip-pattern format [convention, distilled]
- [[conventions/examples-use-generic-placeholders-never-private-names]] — Examples use generic placeholders, never private names [convention]
...
- [[decisions/decision-branch-aware-memory-scoping-via-lifecycle-accrual-not-branch-identity]] — Decision: Branch-aware memory scoping via lifecycle accrual, not branch identity [decision, distilled]
...
- [[decisions/decision-project-naming-via-name-and-tremula-project]] — Decision: Project naming via --name and TREMULA_PROJECT [decision, distilled]
...
- [[decisions/decision-registry-init-creates-vault-upfront]] — Decision: registry init creates vault upfront [decision, distilled]
...
- [[modules/tremula-revise]] — tremula.revise [module, distilled]
